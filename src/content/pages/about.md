---
title: "Sobre"
description: "Conheça a equipe editorial do Cartas 87 a 89, a origem dos dados e os critérios aplicados às análises de EA FC."
---

O **Cartas 87 a 89** é uma publicação editorial especializada em EA FC Ultimate Team. Nosso foco é claro: preços e mercado das cartas 87-89 do EA FC Ultimate Team, todos os dias.

## Quem assina

As publicações são assinadas por **Cartas 87 a 89**. O sistema organiza dados de mercado, produz tabelas e aplica regras editoriais reproduzíveis antes de liberar cada análise. Dúvidas, correções e sugestões podem ser enviadas para [contato@futquant.com](mailto:contato@futquant.com).
